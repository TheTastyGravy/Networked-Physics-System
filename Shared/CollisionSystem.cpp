...
void CollisionSystem::handleCollision(GameObject* object1, StaticObject* object2, bool shouldAffectObject2, CallbackData* callback)
{
	...
	if (colFuncPtr(object1, object2, normal, contact, pen))
	{
		...
		if (callback)
		{
			callback->obj1 = object1;
			callback->obj2 = object2;
			callback->normal = normal;
